...
In order to evaluate whether or not we consider our application a success, we consider the requirements we made in \cnameref{cha:requirements_elicitation}.
...
However, as our test results revealed in \cnameref{cha:test}\mnote{this chapter does not exist in my branch, Troels is working on it}, we did successfully produce an application, able to synchronize not just competitively with AmpMe and SoundSeeder, but better.\mnote{This needs to be specified in regards to best case, avg case, worst case}
