...
However, as our test results revealed in \myref[name]{cha:acctest}, we did successfully produce an application, able to synchronize not just competitively with AmpMe and SoundSeeder, but better.\mnote{This needs to be specified in regards to best case, avg case, worst case}
