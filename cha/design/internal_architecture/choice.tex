...
\mnote{Stefan says `too high lvl and vague', i say bullshit. This section should also pick up on advantages and disadvantages, and explain how the aforementioned will relate to our android development, also i call BS on the incorporation of MVC, we are not going through a controller, we are simply using android development.}
