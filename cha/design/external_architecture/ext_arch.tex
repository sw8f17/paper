\section{External Architecture}\label{sec:external_architectures}
...
To properly manipulate the clock to achieve psychoacoustic effects, even a few milliseconds matter; as such with how the external architecture can affect this, it is a important choice.
