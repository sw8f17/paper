...
Additionally the audio stack on Android will not act in the exact same way wrt. timing on every device, which we will explain in further detain in \cnameref{sec:androidaudiostack}. 
