...
\begin{description}\mnote{requirement ´d´ er besværlig at tilføje her, kan godt være den lige skal reviews så grupperingen giver mere mening}
    \item [Basic Audio Player] \hfill \\
        ...
        With the success of this milestone the following requirements would be fulfilled: \textit{a, e, f, i}.
    \item [Multi--Device Audio Player] \hfill \\
        ...
        The successful implementation of this milestone would fulfill the following requirements: \textit{b, c}.
    \item [Basic Synchronization] \hfill \\
        ...
        Reaching this milestone would fulfill the following requirements: \textit{d}\mnote{dele herfra}.
    \item [Manipulating Playback Offset] \hfill \\ %I dont know in which order we want to go for this or advanced synchronization, they can be swapped without any issues - personally i think this is the correct order.
        ...
        This is also required for us to fulfill the problem statement, as such completing this milestone would not only fulfill the following requirements, but also be considered minimum viable product: \textit{d}\mnote{dele herfra}.
