...
With the data decoded we also create a replacement for the mediaplayer.\mnote{why btw? could we not simply have used the one we alrdy had?}
...
\mnote[inline]{quick explanation of how uppaal was used and the yield of its use}
