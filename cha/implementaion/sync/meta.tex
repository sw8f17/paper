...
This allows the application to work in scenarios where internet is not available, should having prove superior Internet, this could be a default setting, but still support working without Internet available.
