\section{Communication methods}\label{sec:communication_methods}
...
In the attempt to comply with the external architecture described in \cnameref{sec:external_architectures}, we found three methods:
\begin{enumberate*}
...
\subsection{Choosing Connection Method}
