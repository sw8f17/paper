...
\begin{description}
    ...
    \item [\namedlabel{milestone:manipulating_playback_offset}{Manipulating Playback Offset}] \hfill \\ %I dont know in which order we want to go for this or advanced synchronization, they can be swapped without any issues - personally i think this is the correct order.
        \tnote{I disagree with this milestone, maybe we should remove it.}
...
\tnnote{Der mangler et summary eller konklusion på milestones, som samler op på afsnittet.}
