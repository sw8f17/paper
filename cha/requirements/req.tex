...
\begin{eletterate}
    ...
    \begin{eletterate}
        ...
        \item\label{req:change_off} \textbf{The change in offset following a change in media must not exceed $y$ ms.} \hfill\\
        ...
        \item\label{req:pauseplay} \textbf{The change in offset after pausing, and resuming playback of any media must not exceed $y$ ms.} \hfill\\
        ...
        \item\label{req:drift} \textbf{The drift must not exceed $z$ ms over $n$ seconds.} \hfill\\
