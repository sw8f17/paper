...
and start the script\tnnote{Evt. angive hvilket script når de kommer i bilag}. The script takes five measurements and moves the
...
Playback consistency is, like the previous test\tnnote{Igen, hvilket script?}, done by a script. The
