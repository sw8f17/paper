...
In order to perform test for these criteria, we need to have a setup to do so.
...
a time reversed \ac{FFT} of the other.\tnwarning{Jeg forstår ikke denne sætning.} Finally we do an inverse \ac{FFT}
...
We use the song ``Goodness Gracious'' by ``Ellie Goulding''.  We did not
