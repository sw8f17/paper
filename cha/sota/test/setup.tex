...
\begin{figure}[!bht]
    ...
    \caption{An illustration of the test setup with the three phones and the jack cable.\msmnote{New pic on monday, or I do photoshop magic}}\label{fig:test_setup}
\end{figure}
...
\begin{dankscription}{\bfseries}{Master}
    ...
    \item[Slave]OnePlus One (\msmnote{check when I get home})
\end{dankscription}
