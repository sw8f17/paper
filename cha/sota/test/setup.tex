...
Ideally we would also record the reference, the Master, but since we only have two input channels that is not possible.\msmnote{Did we though? Two slaves? Not with Scotty, I guarantee it.}

In the tests we use three Android phones:\msmnote{Right phones?}
