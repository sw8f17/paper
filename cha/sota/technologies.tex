...
Multi-room audio is fairly self-descriptive, it provides audio to several rooms, this audio however is synchronized.\tnnote{Evt. reference til Multi-room Setup fra Increase Volume use case.}
