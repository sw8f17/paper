\section{Multi-Room Audio Systems}\tnnote{Denne sektion er nok lidt tynd på ting vi tager videre.}
...
Both apps also support the feature of manual synchronization, the need for such a feature implies that to some extend the automatic synchronization is not enough.\tnote{This sentence is basis for our requirement (and later milestone), which implies the need for a manual adjustment for synchronization to be sufficiently accurate, this is a problem, as we dont need it to sound good. Removing this could be part of removing/modifieing a requirement and milestone.}
