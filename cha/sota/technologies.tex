...
Netflix\footnote{\url{https://www.netflix.com/}} exclusively\tnnote{Netflix er vel ikke ``exclusively'', men bare førende.} allows for streaming pre--recorded content, e.g. movies and tv--shows.
