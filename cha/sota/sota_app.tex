...
These apps are found by searching through sources like Google\footnote{\url{https://www.google.dk} with the search terms ``android sync music playback''}, YouTube\footnote{\url{https://www.youtube.com/}}, and Google Play Store\footnote{\url{https://play.google.com/store}} and from recommendations on various forums.
