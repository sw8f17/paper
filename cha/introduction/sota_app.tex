...
\begin{table}
    \scalebox{0.9}{
    \begin{tabular}{l|l|l|p{2.2cm}|p{2.2cm}|p{2.4cm}|p{2.0cm}|}
        ...
        \multirow{4}{*}{SoundSeeder} & \multirow{4}{*}{3.9 Play Store}    & \multirow{4}{*}{11/11 2016}    & \multirow{3}{*}{Android 4.1$\le$,} & Google Music, & \multirow{3}{*}{WiFi,} &  \multirow{3}{*}{Free (limited),} \\
    & & & \multirow{3}{*}{Java devices} & YouTube, & \multirow{3}{*}{Android hotspot} & \multirow{3}{*}{39.90 DKK} \\
    & & & & online radio, & & \\
    & & & & local media & & \\ 
