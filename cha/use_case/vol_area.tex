...
As for the other two use cases, these cases are evidently what both AmpMe and SoundSeeder\tnnote{AmpMe og SoundSeeder kommer ud af den blå luft.} are designed for.
